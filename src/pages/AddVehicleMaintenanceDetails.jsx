...
export default function AddVehicleMaintenanceDetails() {
    ...
    const fetchVehicleMaintenanceDetails = async () => {
        if (id) {
            try {
                const response = await axiosApi.get(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/VehicleMaintenance/${id}`);
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            ...
            const response = id
                ? await axiosApi.put(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/VehicleMaintenance/${id}`, dataToSend)
                : await axiosApi.post('https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/VehicleMaintenance', dataToSend);
