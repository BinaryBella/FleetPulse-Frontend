...
export default function EditFuelRefillDetails() {
    ...
    const fetchFuelRefillDetails = async () => {
        try {
            const response = await axiosApi.get(`https://localhost:7265api/FuelRefill/${id}`);
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        ...
        try {
            ...
            const response = await axiosApi.put(`https://localhost:7265api/FuelRefill/${id}`, payload, {
                headers: {
