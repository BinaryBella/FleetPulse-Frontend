...
export default function EditMaintenanceType() {
    ...
    const fetchMaintenanceTypeData = async (id) => {
        try {
            const response = await axiosApi.get(`https://localhost:7265api/VehicleMaintenanceType/${id}`);
    ...
    const handleSubmit = async (values) => {
        try {
            const response = await axiosApi.put(`https://localhost:7265api/VehicleMaintenanceType/UpdateVehicleMaintenanceType`, {
                Id: id,
