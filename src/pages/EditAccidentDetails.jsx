...
export default function EditAccidentDetails() {
  ...
  const fetchAccidentDetails = async () => {
    try {
      const response = await axiosApi.get(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/Accidents/${id}`);
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await axiosApi.put(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/Accidents/${id}`, values);
