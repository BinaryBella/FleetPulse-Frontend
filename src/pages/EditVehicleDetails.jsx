...
export default function EditVehicleDetails() {
    ...
    const breadcrumbs = [
        ...
        { label: "Edit Vehicle Details", link: `/app/EditVehicleDetails/${vehicleId}` },
    ];
    ...
    useEffect(() => {
        ...
        axiosApi.get(`https://localhost:7265/api/Vehicles/${vehicleId}`)
            .then(response => {
    ...
    const handleSubmit = async (values, { setFieldError }) => {
        try {
            ...
            await axiosApi.put(`https://localhost:7265/api/Vehicles/${vehicleId}`, dataToSend);
    ...
    return (
        <>
            ...
            {vehicleDetails && (
                <Formik
                    initialValues={{
                        vehicleRegistrationNo: vehicleDetails.vehicleRegistrationNo || "",
                        licenseNo: vehicleDetails.licenseNo || "",
                        licenseExpireDate: vehicleDetails.licenseExpireDate || "",
                        vehicleColor: vehicleDetails.vehicleColor || "",
                        vehicleType: vehicleDetails.vehicleType || "",
                        manufacturer: vehicleDetails.manufacturer || "",
                        fuelType: vehicleDetails.fuelType || "",
                        status: vehicleDetails.status || false,
                    }}
