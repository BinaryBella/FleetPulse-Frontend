...
export default function FuelRefillDetails() {
    ...
    const fetchFuelRefill = async () => {
        try {
            const response = await axiosApi.get(" http://localhost:5173/api/FuelRefill");
    ...
    const onConfirmDelete = async () => {
        try {
            ...
            const endpoint = ` http://localhost:5173/api/FuelRefill/${selectedFuelRefill.status ? 'deactivate' : 'activate'}/${selectedFuelRefill.fuelRefillId}`;
