...
export default function FuelRefillDetails() {
    ...
    const fetchFuelRefill = async () => {
        try {
            const response = await axiosApi.get("https://localhost:7265api/FuelRefill");
    ...
    const onConfirmDelete = async () => {
        try {
            ...
            const endpoint = `https://localhost:7265api/FuelRefill/${selectedFuelRefill.status ? 'deactivate' : 'activate'}/${selectedFuelRefill.fuelRefillId}`;
