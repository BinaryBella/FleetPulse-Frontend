...
const EditVehicleMaintenanceConfiguration = () => {
    ...
    const fetchMaintenanceConfiguration = async () => {
        try {
            const response = await axiosApi.get(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/VehicleMaintenanceConfiguration/${id}`);
            setInitialValues({
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            const response = await axiosApi.put(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/VehicleMaintenanceConfiguration/${id}`, payload);
