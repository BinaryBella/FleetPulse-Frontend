...
export default function DriverDetails() {
    ...
    const columns = useMemo(() => [
        ...
        { accessorKey: 'emailAddress', header: 'Email', meta: { isNumeric: false, filter: 'text' } },
    ...
    const exportToPDF = () => {
        ...
        // Only include selected columns in the PDF
        const headers = selectedColumns.map(column => column.header);
        const body = previewData.map(item =>
                        ...
                        <Table className="custom-table">
                            ...
                            <Tbody>
                                {previewData.length > 0 ? (
                                    ...
                                    <Tr>
                                        <Td colSpan={selectedColumns.length + 3} textAlign="center">
                                            No data available
                                        </Td>
                                    </Tr>
                                )}
