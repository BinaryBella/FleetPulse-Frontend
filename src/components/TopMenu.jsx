...
export default function TopMenu() {
    ...
    const handleMarkAsRead = async (index, id) => {
        try {
            await axiosApi.post(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/Notification/mark-as-read/${id}`);
    ...
    const handleDeleteNotification = async (index, id) => {
        try {
            await axiosApi.delete(`https://fleetpulsebackenddevelopment20240904063639.azurewebsites.net/api/Notification/delete/${id}`);
